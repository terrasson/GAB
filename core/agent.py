...
class GabAgent:
    ...
    async def _cmd_help(self, msg: Message, _: str) -> Response:
        return Response(text=(
            ...
            "💬 *Tu peux aussi me parler naturellement* — pas besoin de "
            "commande pour les usages courants :\n\n"
            "🗳 *Sondages, rappels, listes, événements* — décris la situation, "
            "je propose l'outil adapté.\n"
            "  • « On hésite entre pizza et sushi pour samedi soir, on "
            "tranche ? » → je lance un sondage.\n"
            "  • « Rappelle-nous de réserver le train demain à 18h. »\n"
            "  • « BBQ chez Marc samedi 19h, ajoute-le à l'agenda. »\n"
            "  • « Qui amène quoi pour le pique-nique ? Salade, dessert, "
            "boissons. » → je crée la liste partagée.\n\n"
            "🧠 *Mémoire du groupe* — je retiens ce qui est durable :\n"
            "  • « Audrey est allergique aux noix. » → je le note pour "
            "toujours.\n"
            "  • « Finalement on annule le dîner. » → j'efface le fait "
            "obsolète.\n\n"
            "🌤 *Météo* — je consulte Open-Meteo et je reformule :\n"
            "  • « Quel temps fait-il samedi à Lyon ? »\n"
            "  • « Météo à Bordeaux pour le week-end. »\n\n"
            "🎫 *Wallet de billets* — forward-moi (ou copie-colle) un mail "
            "de confirmation (TGV, vol, hôtel, concert) en DM ou en groupe :\n"
            "  • « Voici mon billet : TGV INOUI 6815, Paris → Lyon, "
            "12 mai 09h42, voiture 5 place 23, réf. ABC123. »\n"
            "  • Je structure, je sauvegarde, et je programme deux rappels "
            "automatiques (J-1 18h + H-2).\n"
            "  • `/billets` pour relire, `/billets supprimer <id>` pour "
            "retirer.\n\n"
            "📝 *Récap & synthèse* — `/recap [jours]` à la demande, plus un "
            "récap auto le dimanche soir si le groupe a été actif."
        ))
